...
public class HotelMain {
    public static void main(String[] args) {
        ...
        try {
            connection = conexaoSysHotel.getConexao();
            if (connection == null) {
...
//----------------------------------------------------------------------------------------------------------------------
                    case 5: // Sair
                        System.out.println(" - Saindo do do sistema ...");
                        System.out.println(" - Obrigado por usar o sistema de hotel!");
                        break;
...
//----------------------------------------------------------------------------------------------------------------------
            ...
            conexaoSysHotel.closeConexao(connection);
            entrada.close();
        }
    }
}
