...
CREATE TABLE `quartos` (
  ...
  `quarto_disponivel` tinyint(1) DEFAULT '1',
  `quartos_tq_id` int NOT NULL,
  PRIMARY KEY (`quartos_id`),
  UNIQUE KEY `numero` (`numero`),
  KEY `quartos_tq_id` (`quartos_tq_id`),
  CONSTRAINT `quartos_ibfk_1` FOREIGN KEY (`quartos_tq_id`) REFERENCES `tipo_quartos` (`tipo_quartos_id`)
